...
namespace BullardEncuestas.Data
{
    ...
    public partial class BULLARDEncuestasEntities : DbContext
    {
        ...
        public virtual ObjectResult<SP_GetEncuestas2_Result2> SP_GetEncuestas2()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_GetEncuestas2_Result2>("SP_GetEncuestas2");
        }
    }
}
